...
- Added stricter YouTube video ID validation (11-character IDs) with support for `watch`, `youtu.be`, `shorts`, `embed`, `live`, and `attribution_link` URL patterns, plus direct ID input.
